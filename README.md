# uitable [![GoDoc](https://godoc.org/github.com/tot-git27/uitable?status.svg)](https://godoc.org/github.com/tot-git27/uitable) [![Build Status](https://travis-ci.org/tot-git27/uitable.svg?branch=master)](https://travis-ci.org/tot-git27/uitable)
...
```
$ go get -v github.com/tot-git27/uitable
```
